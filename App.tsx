...
/**
 * ARCHIVO: App.tsx
 * DESCRIPCIÓN: Orquestador central Check Vector optimizado para altura dinámica y UI limpia.
 */
        ...
        <div className="flex-1 overflow-hidden flex flex-col lg:flex-row h-full">
          <div className="flex-1 relative bg-slate-50 flex items-center justify-center p-4 lg:p-8 overflow-auto no-scrollbar">
            {mode === AppMode.CATALOG ? (
              ...
              <div className="text-center bg-white p-8 md:p-16 rounded-[3rem] md:rounded-[4rem] shadow-2xl border border-slate-100 max-w-xl animate-in fade-in zoom-in-95 duration-1000 mx-4">
                <div className="w-16 h-16 md:w-24 md:h-24 bg-indigo-600 rounded-[1.5rem] md:rounded-[2rem] flex items-center justify-center mx-auto mb-6 md:mb-10 shadow-2xl shadow-indigo-100 animate-float">
                  <Target className="w-8 h-8 md:w-12 md:h-12 text-white" />
                </div>
                <h3 className="text-2xl md:text-4xl font-black text-slate-900 mb-4 tracking-tight">Comience su gestión</h3>
                <p className="text-slate-500 text-sm md:text-lg mb-8 md:mb-12 leading-relaxed font-medium">Suba un plano técnico para empezar a identificar activos o seleccione uno de su base de datos.</p>
                <label className="inline-flex items-center gap-3 bg-indigo-600 text-white px-8 md:px-12 py-3 md:py-5 rounded-full font-bold cursor-pointer hover:bg-indigo-700 hover:scale-105 transition-all shadow-2xl shadow-indigo-100 text-sm md:text-base">
